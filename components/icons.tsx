...
export const InstagramIcon: React.FC<SimpleImageProps> = ({ className, alt }) => (
  <img
    src="https://raw.githubusercontent.com/riquelima/salaotest/refs/heads/main/logoinsta.png"
    alt={alt || "Instagram"}
